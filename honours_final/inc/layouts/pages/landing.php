...
$products_item .= <<<EOT
                                        ...
                                        <div class="product-thumb"><img src="img/thumbnails/{$obj->product_img_name}"></div>
                                            ...
                                            <div class="caption-text">
                                                <div class="captionbuttons">
                                                    <a href="product_detail.php" class="captiondetails"><i class="fa fa-link"></i> View Details</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        <div class="notesarea">
                                        <a href="productsingle.html" title="Travel Fashion">
                                            <a href="#"><h2>{$obj->product_name}</h2>
                                            </a>
    ...
    <div align="center"><button type="submit" class="edd-add-to-cart">Add</button>
    </form>
